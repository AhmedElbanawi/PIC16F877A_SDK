...
void GPIO_SetPortValue(const GPIO_Port_ID_t GPIO_PORT_ID,
     ...
     switch(GPIO_PORT_ID){
          case GPIO_PORTA:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTA_WRITE_ADDRESS;
               break;
          case GPIO_PORTB:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTB_WRITE_ADDRESS;
               break;
          case GPIO_PORTC:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTC_WRITE_ADDRESS;
               break;
          case GPIO_PORTD:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTD_WRITE_ADDRESS;
               break;
          case GPIO_PORTE:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTE_WRITE_ADDRESS;
               break;
          default:
               /* Error: Undefined Port */
               return;
...
Word_Size_t GPIO_ReadPortValue(const GPIO_Port_ID_t GPIO_PORT_ID){
     ...
     switch(GPIO_PORT_ID){
          case GPIO_PORTA:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTA_READ_ADDRESS;
               break;
          case GPIO_PORTB:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTB_READ_ADDRESS;
               break;
          case GPIO_PORTC:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTC_READ_ADDRESS;
               break;
          case GPIO_PORTD:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTD_READ_ADDRESS;
               break;
          case GPIO_PORTE:
               Port_Value_Ptr = (volatile Word_Size_t*)PORTE_READ_ADDRESS;
               break;
          default:
               /* Error: Undefined Port */
               return PORT_ERROR;
